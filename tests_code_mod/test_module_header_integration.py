#!/usr/bin/env python3
"""
Integration tests for module_header with the full modification system.
Place this in: tests_code_mod/test_module_header_integration.py
"""
...
import subprocess
import pytest
from code_mod_defs import apply_modification_set, modification_description, module_header


class TestModuleHeaderIntegrationWithGit:
    """Integration tests with git rollback system"""
    
    def test_module_header_creates_commit(self, tmp_git_repo):
        """Test that module_header modifications create proper git commits"""
        ...
        with chdir(repo):
            ...
            # Apply module_header modification
            modifications = [
    ...
    def test_module_header_rollback_functionality(self, tmp_git_repo):
        """Test rollback works correctly with module_header modifications"""
        repo, chdir = tmp_git_repo
        with chdir(repo):
...
class TestModuleHeaderWithOtherModifications:
    """Test module_header combined with other modification types"""
    
    def test_module_header_with_declare_modifications(self, tmp_git_repo):
        """Test module_header combined with declare modifications"""
        repo, chdir = tmp_git_repo
        with chdir(repo):
    ...
    def test_module_header_with_file_operations(self, tmp_git_repo):
        """Test module_header with create_file and move_file operations"""
        repo, chdir = tmp_git_repo
        with chdir(repo):
            ...
            modifications = [
                ...
                (module_header, ("src/utils.py", textwrap.dedent("""
...
class TestModuleHeaderParsingIntegration:
    """Test module_header parsing within the modification file system"""
    
    def test_parse_module_header_from_file(self, tmp_path):
        """Test parsing module_header directive from modification file"""
        ...
        # Second modification should be module_header
        header_func, header_args, header_kwargs = modifications[1]
        assert header_func.__name__ == "module_header"
    ...
    def test_end_to_end_modification_workflow(self, tmp_git_repo, tmp_path):
        ...
        with chdir(repo):
            ...
            print("✓ End-to-end module_header workflow test completed successfully")


if __name__ == "__main__":
    print("Module Header Integration Test Suite")
    print("Run with: pytest test_module_header_integration.py -v")
